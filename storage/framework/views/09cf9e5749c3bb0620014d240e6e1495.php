...
<head>
    ...
    <title><?php echo e($config['appName']); ?></title>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css')); ?>?v=dropdown-fix-1">
    <script>
        window.SNAILLY_CONFIG = <?php echo json_encode($config, 15, 512) ?>;
        window.SNAILLY_INITIAL_PAGE = <?php echo json_encode($page, 15, 512) ?>;
    </script>
</head>
<body>
    ...
    <main id="app" class="app">
        <section data-page="home" class="page page-center auth-bg">
            <div class="home-card glass-card">
                <img class="logo big-logo" src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Snailly logo">
        ...
        <section data-page="login" class="page page-center auth-bg">
            <form id="loginForm" class="auth-card glass-card">
                <img class="logo" src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Snailly logo">
                <h1>Login</h1>
                <label>Email
        ...
        <section data-page="dashboard" class="page dashboard-layout">
            <?php echo $__env->make('snailly.partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script src="<?php echo e(asset('assets/js/app.js')); ?>?v=report-log-limit-1"></script>
</body>
</html>
<?php /**PATH C:\laragon\www\snailly\resources\views/snailly/app.blade.php ENDPATH**/ ?>